...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO tblambulancehiring 
    (BookingNumber, PatientName, RelativeName, RelativeConNum, 
    HiringDate, HiringTime, AmbulanceType, Address, City, State, Message) 
    VALUES ('$bookingnum', '$pname', '$rname', '$phone', '$hdate', '$htime', 
...
<head>
  ...
  <title>SAUKYADANA Emergancy Ambulance Hiring Portal || Home Page</title>
  <link rel="icon" type="image/png" href="assets/img/Logo Large.png">
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/1.png)">
          <div class="container">
            <h2>Welcome to <span>සෞඛ්‍යදාන Emergency Ambulance Hiring Portal</span></h2>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/2.png)">
          <div class="container">
            <h2>Welcome to <span>සෞඛ්‍යදාන Emergency Ambulance Hiring Portal</h2>
...
?>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>If you have any questions, need assistance, or wish to provide feedback regarding our services, we are here to help. The සෞඛ්‍යදාන platform is dedicated to ensuring fast, reliable, and accessible emergency ambulance services across Sri Lanka. You can reach us via email or our 24/7 emergency hotline. Our team is always ready to support you during critical times.

Whether it’s an inquiry about an ambulance booking, technical support, or general information, don’t hesitate to get in touch. Your safety and satisfaction are our priority.</p>
        </div>
